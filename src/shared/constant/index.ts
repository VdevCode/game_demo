...
export const CHARACTORS: IBirdDefault[] = [
  ...
  },
  {
    ...
    hp: 100,
    speed: 0.35,
    imgAvatar: images.charactor4_avatar,
    imgDefault: images.CHARACTOR4_DEFAULT,
    imgUpping: images.CHARACTOR4_UPPING,
    imgDown: images.CHARACTOR4_DOWN,
    imgDie: images.CHARACTOR4_DIE,
    imgWin: images.CHARACTOR4_WIN,
    name: 'Foxy',
    introl: 'Cô ấy rất lười',
    role: 0,
  },
  {
    ...
    hp: 100,
    speed: 0.35,
    imgAvatar: images.charactor5_avatar,
    imgDefault: images.CHARACTOR5_DEFAULT,
    imgUpping: images.CHARACTOR5_UPPING,
    imgDown: images.CHARACTOR5_DOWN,
    imgDie: images.CHARACTOR5_DIE,
    imgWin: images.CHARACTOR5_WIN,
    name: 'Foxy',
    introl: 'Cô ấy rất lười',
    role: 0,
  },
  {
    ...
    hp: 100,
    speed: 0.35,
    imgAvatar: images.charactor6_avatar,
    imgDefault: images.CHARACTOR6_DEFAULT,
    imgUpping: images.CHARACTOR6_UPPING,
    imgDown: images.CHARACTOR6_DOWN,
    imgDie: images.CHARACTOR6_DIE,
    imgWin: images.CHARACTOR6_WIN,
    name: 'Foxy',
    introl: 'Cô ấy rất lười',
    role: 0,
  },
